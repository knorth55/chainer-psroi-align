...
class FCISPSROIAlignResNet101(FCIS):
    ...
    """FCIS using ROI Align based on ResNet101.
    ...
    * :obj:`sbd`: Loads weights trained with the trainval split of Semantic \
    ...
    def __init__(
        ...
        super(FCISPSROIAlignResNet101, self).__init__(
            extractor, rpn, head,
...
class FCISResNet101Head(chainer.Chain):
    ...
    def _pool(
        ...
        roi_cls_ag_seg_scores = psroi_align_2d(
        ...
        roi_ag_loc_scores = psroi_align_2d(
